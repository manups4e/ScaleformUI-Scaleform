class com.rockstargames.ui.components.GUIView
{
	...
	{
        com.rockstargames.ui.utils.Debug.log("3 - addItem: " + arguments.toString());
	...
	function direction(targetIndex)
	{
		...
		if (this.maxitems > 1)
		{
			if (targetIndex == 0 && this._index == this.maxitems - 1)
			{
				_loc2_ = 1;
			}
			if (targetIndex == this.maxitems - 1 && this._index == 0)
			{
				_loc2_ = -1;
			}
		}
