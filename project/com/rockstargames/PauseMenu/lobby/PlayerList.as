class com.rockstargames.PauseMenu.lobby.PlayerList
{
	...
	function AddItem(before, index, id, param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13)
	{
		...
		if (id == 0)
		{
			item = new com.rockstargames.PauseMenu.lobby.tabs.matchmaking.PlayerItem(this, this.scrollableContent, index, param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13);
			item.itemMC._x = item.itemMC._x - 25;
		}
		else if (id == 1)
		{
			item = new com.rockstargames.PauseMenu.lobby.tabs.matchmaking.FriendItem(this, this.scrollableContent, index, param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13);
		}
