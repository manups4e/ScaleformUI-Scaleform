class com.rockstargames.PauseMenu.lobby.MissionList
{
	var _MC;
	var _parentMC;
	...
	function MissionList(parent, offset, id)
	{
		...
		this.BodyMask = this._MC.attachMovie("pauseMenuRightBody", "Body_missions", this._MC.getNextHighestDepth());
		...
		this.Footer = this._MC.attachMovie("Footer", "footer_missions", this._MC.getNextHighestDepth());
	...
	function AddItem(before, index, id, param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14)
	{
		...
		if (id == 0 || id == 1)
		{
			item = new com.rockstargames.PauseMenu.lobby.mpFreemodeItem(this, id, index, param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14);
		}
